            ...
            <div class="w-10 h-10 rounded-xl bg-blue-600
                ...
                <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path stroke-linecap="round"
                          ...
                          stroke-width="2"
                          d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-2m0-6h3a1 1 0 011 1v4a1 1 0 01-1 1h-3m0-6v6"/>
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <p class="text-xs text-gray-500 mt-2">
            Money earned from completed work
        </p>
    </div>
    ...
    <div class="bg-white rounded-xl shadow p-6">
        ...
        <p class="text-xs text-gray-500 mt-2">
            Money spent on accepted solutions
        </p>
    </div>
